    ...
    <div className="flex h-screen justify-center items-center w-full bg-hover">
      <div className="bg-background flex flex-col items-center px-6 lg:px-12 py-6 rounded-md max-w-[400px] w-[90%]">
        ...
        <form onSubmit={handleSignup}>
          ...
          <input onChange={(e) => setPassword(e.target.value)} value={password} type="text" placeholder="Your Password" className="outline-none border-1 border-neutral-600 p-2  w-full rounded-md text-primary-text placeholder-neutral-600 mb-6 focus:text-secondary-text" />
